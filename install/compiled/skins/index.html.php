...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    <td height="25" align="right">主域名：</td>
    <td><input name="domain" type="text" id="domain" value="deitui.com" />
      (网址:ww.wdeitui.com 开启二级域名请不要填写www)</td>
  </tr>
  <tr>
  	<td>wap域名：</td>
    <td><input name="wapurl" type="text" value="m.deitui.com" /></td>
  </tr>
