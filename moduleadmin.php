...
/*视图模版配置*/
$cache_dir="";//模版缓存文件夹
$template_dir="module/".$module."/themes/admin";//模版风格文件夹
$wap_template_dir="module/".$module."/themes/admin";//模版风格文件夹
...
function userinit(&$base){
	...
	$base->smarty->assign(array(
		"skins"=>"/themes/admin/",
		"skinsmodule"=>"/module/".$module."/themes/admin/",
		"skinsdefaultdir"=>"themes/admin",
	));
	$base->smarty->assign(
		array(
			"appindex"=>APPINDEX,
