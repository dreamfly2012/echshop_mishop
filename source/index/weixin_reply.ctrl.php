	...
	*/
	...
	class weixin_replyControl extends skymvc{
		...
		public function __construct(){
			parent::__construct();
			$this->loadmodel(array("weixin_reply","weixin","login"));
		...
		public function onDefault(){
			...
			$url="/index.php?m=weixin_reply&a=default";
			$limit=20;
			...
			$rscount=true;
			$data=$this->weixin_reply->select($option,$rscount);
		...
		public function onDelete(){
			$id=get_post('id',"i");
			$this->weixin_reply->delete("id={$id}");
